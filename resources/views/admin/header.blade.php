...
<nav class="navbar navbar-expand-lg main-navbar sticky">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="{{asset('admin/img/user.png')}}" class="user-img-radious-style"> <span class="d-sm-none d-lg-inline-block"></span></a>
            <div class="dropdown-menu dropdown-menu-right pullDown">
                ...
                <a href="{{ route('home') }}" class="dropdown-item has-icon"> <i class="fas fa-home"></i> Trang chủ
                </a>
                <div class="dropdown-divider"></div>
                <form id="logout-form" action="{{route('dangxuat')}}" method='post'>
                    @csrf
                <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i> Đăng xuất
                </a>
                </form>
            </div>
        </li>
...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('admin.dashboard') }}"> <img alt="image" src="{{asset('admin/img/logo.png')}}" class="header-logo" /> <span class="logo-name">Otika</span>
            </a>
        </div>
        <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown active">
                <a href="{{ route('admin.dashboard') }}" class="nav-link"><i data-feather="monitor"></i><span>Tổng quan</span></a>
            </li>
            <li class="dropdown">
                <a href="{{ route('admin.users') }}" class="nav-link"><i data-feather="users"></i><span>Tài khoản</span></a>
            </li>
            <li class="dropdown">
                <a href="{{ route('admin.categories') }}" class="nav-link"><i data-feather="book-open"></i><span>Danh mục</span></a>
            </li>
            <li class="dropdown">
                <a href="{{ route('admin.products') }}" class="nav-link"><i data-feather="layout"></i><span>Sản phẩm</span></a>
            </li>
            <li class="dropdown">
                <a href="{{ route('admin.orders') }}" class="nav-link"><i data-feather="package"></i><span>Đơn hàng</span></a>
            </li>
        </ul>
    </aside>
</div>